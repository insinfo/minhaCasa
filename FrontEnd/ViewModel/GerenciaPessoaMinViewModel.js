...
function GerenciaPessoaViewModel() {
    ...
    this.btnIrParaNovaSolicitacao = $('#btnIrParaNovaSolicitacao');
...
GerenciaPessoaViewModel.prototype.init = function () {
    var self = this;
    self.token = sessionStorage.getItem('YWNjZXNzX3Rva2Vu');
    //inicialiaza plugins
    $('body').find('select').not('.dataTableSelectItemsPerPage').selectpicker();
...
GerenciaPessoaViewModel.prototype.eventos = function () {
    ...
    //btn ir para nova solicitação
    self.btnIrParaNovaSolicitacao.click(function () {
        var route = '/ciente/novaSolicitacao';
        route += '?p=' + self.token;
...
GerenciaPessoaViewModel.prototype.updateFields = function () {
    var self = this;
    var selects = $('body').find('select').not('.dataTableSelectItemsPerPage');
...
GerenciaPessoaViewModel.prototype.getAllPessoasFisica = function () {
    ...
    self.dataTablePessoaFisica.hideActionBtnDelete();
...
GerenciaPessoaViewModel.prototype.getAllPessoasJuridica = function () {
    ...
    self.dataTablePessoaJuridica.hideActionBtnDelete();
