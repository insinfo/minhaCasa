...
<head>
    ...
    <script type="text/javascript" src="/ViewModel/GerenciaPessoaMinViewModel.js"></script>
                    ...
                    <div class="page-header-content">
                        ...
                        <div class="heading-elements">
                            <div class="heading-btn-group">
                                <a id="btnIrParaNovaSolicitacao" class="btn bg-orange btn-labeled heading-btn legitRipple">
                                    <b><i class="icon-compose"></i></b>Nova Solicitação
                                </a>
                                <button class="btnSalvar btn bg-blue btn-labeled heading-btn legitRipple">
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="panel panel-flat border3-grey">
                                                    <div class="panel-body">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <!-- <a id="btnShowTabPessoaFisica" href="#"
                                                                    data-toggle="tab">
                                                                     <i class="icon-user position-left"></i> Pessoa Física
                                                                 </a>
                                                                 <a id="btnShowTabPessoaJuridica" href="#"
                                                                    data-toggle="tab">
                                                        ...
                                                        <div class="" id="tabPessoaFisica">
                                                            ...
                                                            <div class="form-group">
                                                                <div class="row">
                                                                    <div class="col-md-3 inputBlock">
                                                                        <label>Sexo</label>
                                                                        <select id="selectSexo" class="select" required data-type="string">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3 inputBlock">
                                                                        ...
                                                                        <select id="selectEstadoOrgaoEmissor"
                                                                                class="select" data-type="int" data-live-search="true">
