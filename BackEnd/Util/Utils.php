...
use PmroPadraoLib\Model\VO\Token;
use DateTime;
...
class Utils
{
    ...
    //checa se uma variavel string ou um key de um array esta definido e se o valor é nulo ou vazio
    public static function isSetNullOrEmpty($stringOrArray, $key = null)
    {
        if (is_array($stringOrArray)) {
            if ($stringOrArray == null || isset($stringOrArray[$key]) == false) {
                return false;
            } else {
                if ($stringOrArray[$key] == null || $stringOrArray[$key] == '' || $stringOrArray[$key] == 'null') {
                    return false;
                }
            }
        } else if (is_string($stringOrArray)) {
            if (isset($stringOrArray) == false || $stringOrArray == null || trim($stringOrArray) === "" || trim($stringOrArray) === 'null') {
                return false;
            }
    ...
    public static function parseTimestamp($timestamp, $format = 'd/m/Y')
    {
    ...
    public static function getUserLogged ($request) {
